...
export interface VoiceState {
    ...
    /**
     * @property { Snowflake | undefined } channel_id - the channel id this user is connected to
     */
    ...
    /**
     * @property { string | undefined } request_to_speak_timestamp - the time at which the user requested to speak
